// Extracted from src/main/libs/coworkMemoryJudge.ts

import type { CoworkMemoryGuardLevel } from './coworkMemoryExtractor';
import { isQuestionLikeMemoryText } from './coworkMemoryExtractor';

// Mock or simplified version of resolveCurrentApiConfig since we don't have the full context
// You will need to implement this or provide the config mechanism for your project
