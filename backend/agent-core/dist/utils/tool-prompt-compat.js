...
exports.getCompatToolInvocationReminderForLoadedSkill = getCompatToolInvocationReminderForLoadedSkill;
...
function getCompatToolInvocationReminderForLoadedSkill() {
    return [
        "【兼容模式 · 工具调用（权威格式）】",
