...
This capability provides architectural review for OpenSpec changes, ensuring compliance with project design principles and coding conventions.
...
- **WHEN** 用户在当前对话框中触发 	rae-architect Skill 审查某个 OpenSpec 变更
...
- **WHEN** 被审工件中提议在 gateway 侧使用 ar、Records 或 List.of() 等 Java 9+ 特性
