# trae-architect-review Specification

## Purpose

TBD - 此 spec 定义 TRAE Architect Skill 的行为规范，包括 Skill 的定义与加载、功能清单完整性、架构设计哲学文档、三层代码规约、评审触发时机与流程、评审结果记录格式、以及 Skill 版本同步机制。
